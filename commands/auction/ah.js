...
class ccAh extends Commando.Command {
  constructor(client) {
    super(client, {
      ...
      memberName: "ah",
      description:
        "Shows details about what an item costs on the auction house.",
      details:
        "Auction data can be up to an hour old as this is a limitation of the Blizzard servers",
      examples: [
        "$ah Starlight Rose Ysondre EU, $ah foxflower, $ah Flask of ten thousand scars",
      ],
      argsCount: 2,
      argsType: "multiple",
    });
